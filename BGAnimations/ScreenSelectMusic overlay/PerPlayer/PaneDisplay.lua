...
af[#af+1] = LoadFont("Common Normal")..{
	...
	InitCommand=function(self) self:x(highscoreX):y(Y_row2):zoom(zoom_factor):diffuse(Color.Black):horizalign(right) end
}

--PLAYER PROFILE highscore name
af[#af+1] = LoadFont("Common Normal")..{
	Name="PlayerHighScoreName",
	InitCommand=function(self) self:x(highscorenameX):y(Y_row2):zoom(zoom_factor):diffuse(Color.Black):horizalign(left):maxwidth(80) end
}
