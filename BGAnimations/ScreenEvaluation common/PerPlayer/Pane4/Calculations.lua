...
local arrows = { "Left", "Down", "Up", "Right", "All" }
local arrow = 5 -- all arrows
...
af[#af+1] = Def.ActorMultiVertex{
	...
	OnCommand=function(self)
		self:SetDrawState{Mode="DrawMode_QuadStrip"}
			:SetVertices(calcGraph(offsets))
	end,
	UpdateGraphMessageCommand=function(self, params)
		arrow = params.arrow
		self:SetDrawState{Mode="DrawMode_QuadStrip"}
			:SetVertices(calcGraph(params.offsets))
	end
}
...
af[#af+1] = Def.BitmapText{
	...
	InitCommand=function(self)
		self:x(40):y(-pane_height+82)
			:zoom(0.8)
	end,
	UpdateGraphMessageCommand=function(self, params)
		self:settext(arrows[params.arrow])
	end
}
